...
```{r}
# Caco2
caco2_low <- read.table("./data/data-pre-processing/TiO2_24hrs_10_Caco2.txt", sep = "\t", header = T)
caco2_high <- read.table("./data/data-pre-processing/TiO2_24hrs_100_Caco2.txt", sep = "\t", header = T)
# SAE
SAE_low <- read.table("./data/data-pre-processing/TiO2_24hrs_10_SAE.txt", sep = "\t", header = T)
SAE_high <- read.table("./data/data-pre-processing/TiO2_24hrs_100_SAE.txt", sep = "\t", header = T)
# THP1
THP1_low <- read.table("./data/data-pre-processing/TiO2_24hrs_10_THP1.txt", sep = "\t", header = T)
THP1_high <- read.table("./data/data-pre-processing/TiO2_24hrs_100_THP1.txt", sep = "\t", header = T)
...
filteredPlot(x = "up", cell = "Caco2", conc = "L")
filteredPlot(x = "down", cell = "Caco2", conc = "L")
filteredPlot(x = "up", cell = "Caco2", conc = "H")
filteredPlot(x = "down", cell = "Caco2", conc = "H")

filteredPlot(x = "up", cell = "SAE", conc = "L")
filteredPlot(x = "down", cell = "SAE", conc = "L")
filteredPlot(x = "up", cell = "SAE", conc = "H")
filteredPlot(x = "down", cell = "SAE", conc = "H")

filteredPlot(x = "up", cell = "THP1", conc = "L")
filteredPlot(x = "down", cell = "THP1", conc = "L")
filteredPlot(x = "up", cell = "THP1", conc = "H")
filteredPlot(x = "down", cell = "THP1", conc = "H")
```
