...
```{r}
cl <- EnhancedVolcano(data,title = "CACO2 10 ug/ml 24h", lab = data$hgnc_symbol, x = 'caco2_L_logFC',y = 'caco2_L_pval', xlim = c(-2, 2), FCcutoff = 0.26, pCutoff = 0.05)

ch <- EnhancedVolcano(data,title = "CACO2 100 ug/ml 24h", lab = data$hgnc_symbol, x = 'caco2_H_logFC',y = 'caco2_H_pval', xlim = c(-2, 2), FCcutoff = 0.26, pCutoff = 0.05)

sl <- EnhancedVolcano(data,title = "SAE 10 ug/ml 24h", lab = data$hgnc_symbol, x = 'SAE_L_logFC',y = 'SAE_L_pval', xlim = c(-2, 2), FCcutoff = 0.26, pCutoff = 0.05)

sh <- EnhancedVolcano(data,title = "SAE 100 ug/ml 24h", lab = data$hgnc_symbol, x = 'SAE_H_logFC',y = 'SAE_H_pval', xlim = c(-2, 2), FCcutoff = 0.26, pCutoff = 0.05)

tl <- EnhancedVolcano(data,title = "THP1 10 ug/ml 24h", lab = data$hgnc_symbol, x = 'THP1_L_logFC',y = 'THP1_L_pval', xlim = c(-2, 2), FCcutoff = 0.26, pCutoff = 0.05)

th <- EnhancedVolcano(data,title = "THP1 100 ug/ml 24h", lab = data$hgnc_symbol, x = 'THP1_H_logFC',y = 'THP1_H_pval', xlim = c(-2, 2), FCcutoff = 0.26, pCutoff = 0.05)

png(file="volcanoplots.png", width = 1020, height = 1080)
par(mar=c(1, 1, 1, 1))
